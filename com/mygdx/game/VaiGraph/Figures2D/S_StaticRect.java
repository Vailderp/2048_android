...
public class S_StaticRect {
    public Vector<StaticRect> elements = new Vector<>();

    public void addElement(StaticRectData staticRectData, RectData data)
    {
        elements.addElement(new StaticRect(staticRectData, data));
    }

    public StaticRect getElement(int index) {
        return elements.get(index);
    }
    public StaticRect getElement(float index) {
